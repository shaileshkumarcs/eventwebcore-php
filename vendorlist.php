    ...
    <div class="">
        ...
        <div class="panelbody" style="padding: 10px 0px 0px 20px;width: 80vw;">
            ...
            <div class="" style="display: flex;justify-content: space-between;align-items: center;background-color: #f5f5f5;padding:10px 10px 10px 10px;margin-bottom: 10px;">
              ...
              <div>
                <a href="vendor.php" class="btn btn-success">Create Vendor</a>
              </div>
            </div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="vendoredit.php?vendorid=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a><a href="vendordelete.php?vendorid=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                  </tr>
                  <?php
                  $i++;
                    }
