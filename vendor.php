...
$query = "SELECT * FROM `vendortype` where status='1'";
$result = mysqli_query($con,$query) or die(mysql_error());


$query = "SELECT * FROM `city` where status='Active'";
$cityList = mysqli_query($con,$query) or die(mysql_error());
        ...
        <div class="panelbody" style="padding: 10px 0px 0px 20px;width: 80vw;">
            ...
            <div class="cardbody" style="background-color: #f5f5f5; padding: 10px 10px 10px 10px;">
              ...
              if(isset($_REQUEST['brandname']))
              {
                ...
                $query = "INSERT into `vendors` (brandname, cityname,vendortype,email,phone,password, address,created_at) VALUES ('$brandname','$cityname','$vendortype','$email', '$phone', '".md5($password)."','$address','$created_at')";


                $result = mysqli_query($con,$query);

                if($result){
                    echo "<div class='form'><h3>Vendor created successfully.</h3></div>";
                }
