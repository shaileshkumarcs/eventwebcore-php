            ...
            <div class="cardbody" style="background-color: #f5f5f5; padding: 10px 10px 10px 10px;">
              ...
              <?php
                ...
                if($row ==  1){
                  ...
                  if($result){
                      echo "<div class='form'><h3>Vendor deleted successfully.</h3><p> Click <a href='vendorlist.php'>here</a> to redirect vendor list page.</p></div>";
                  }

                }
                else{
                  echo "<div class='form'><h3>Selected vendor is not availabe.</h3> <p> Click <a href='vendorlist.php'>here</a> to redirect vendor list page.</p></div>";
                }
              ?>
            </div>
        </div>
