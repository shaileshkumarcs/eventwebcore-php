        ...
        <div class="panelbody" style="padding: 10px 0px 0px 20px;width: 80vw;">
            ...
            <div class="cardbody" style="background-color: #f5f5f5; padding: 10px 10px 10px 10px;">
              ...
              if(isset($_REQUEST['categoryname']))
              {
                ...
                $query = "INSERT into `vendortype` (name, value,created_at) VALUES ('$categoryname','$categoryvalue','$created_at')";


                $result = mysqli_query($con,$query);

                if($result){
                    echo "<div class='form'><h3>Category created successfully.</h3></div>";
                }
              ...
              <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="categoryvalue" placeholder="Category Value">
                </div>
...
id uninque and primary key
categoryname varchar(100) not null,
catagoryvalue varchar(100) not null unique,
cateted_at
updated_at
deleted_at
